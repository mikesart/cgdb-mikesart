 ...
 *
 * \param color
 * Color name. Ie: Blue, DarkBlue, LightBlue, etc.
 *
 * \return
 * hl_group_kind color enum, or HLG_LAST if not found
 */
enum hl_group_kind hl_get_color_group(hl_groups_ptr hl_groups, const char *color);
